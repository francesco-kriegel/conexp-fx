...
//            .text(conExpTab.fca.context.isHomogen() ? "New Element" : "New Object")
    ...
    final ImageView view =
        ImageViewBuilder.create().image(new Image(GUI.class.getResourceAsStream("image/16x16/add.png"))).build();
...
//            .text(conExpTab.fca.context.isHomogen() ? "New Element" : "New Attribute")
        ...
        .build();
    final ImageView view2 = ImageViewBuilder
        .create()
        .image(new Image(GUI.class.getResourceAsStream("image/16x16/add.png")))
        .build();
