...
import de.tudresden.inf.tcs.fcalib.AbstractClosureOperator;
...
//      testAgainstOldImplementationForImplications(prefix + filename);
  ...
  public void testAgainstOldImplementationForExtents(final String filename) {
    ...
    final NextClosure<String> nc = new NextClosure<String>(cxt.rowHeads(), new AbstractClosureOperator<String>() {
