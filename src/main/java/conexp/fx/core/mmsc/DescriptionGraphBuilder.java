...
import conexp.fx.core.mmsc.Interpretation.DescriptionLogic;
import conexp.fx.experiment.conelk.ddt.TTD_Example;
...
public class DescriptionGraphBuilder {
  ...
  public final static Interpretation testDDT_() throws RepositoryException {
    final Interpretation in = new Interpretation(10000, 10000, 10000);
...
//        break;
  ...
  public final static Interpretation test57_() {
    final Interpretation in = new Interpretation(6, 4, 1);
    for (String s : new String[] { "Kirk", "Luann", "Milhouse", "Clancy", "Jackie", "Selma" })
      in.addIndividual(s);
    for (String s : new String[] { "Male", "Female", "Father", "Mother" })
      in.addConcept(s);
  ...
  public static void main(String[] args) {
    ...
    final Interpretation in = test57_();
    ...
    try {
      final Interpretation inDDT = testDDT_();
